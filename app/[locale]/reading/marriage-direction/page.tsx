...
import { MarriageDirectionTool } from "../../../components/readings/marriage-direction-tool";
import { getDictionary, hasLocale } from "../../../../lib/i18n";

type MarriageDirectionPageProps = PageProps<"/[locale]/reading/marriage-direction">;

export default async function MarriageDirectionPage(props: MarriageDirectionPageProps) {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-6 py-10 sm:px-8 lg:px-12">
      ...
      <MarriageDirectionTool locale={locale} />
    </main>
  );
}
