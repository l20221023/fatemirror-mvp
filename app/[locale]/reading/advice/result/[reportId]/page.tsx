...
import { AdviceReportLoader } from "../../../../../components/advice/advice-report-loader";
import { LanguageSwitcher } from "../../../../../components/language-switcher";
import { getDictionary, hasLocale } from "../../../../../../lib/i18n";

type LocalizedAdviceResultPageProps = PageProps<"/[locale]/reading/advice/result/[reportId]">;
...
export default async function LocalizedAdviceResultPage(
  ...
  if (!hasLocale(locale) || !reportId) notFound();
    ...
    <main className="mx-auto w-full max-w-6xl px-6 py-10 sm:px-8 lg:px-12">
      <div className="mb-10 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center justify-end gap-3">
          <LanguageSwitcher locale={locale} pathSuffix={`/reading/advice/result/${reportId}`} />
          <Link
      ...
      <AdviceReportLoader locale={locale} copy={advice} reportId={reportId} />
    </main>
  );
}
